...
[![Coverage Status](https://img.shields.io/codecov/c/github/chris-prener/qualmap/master.svg)](https://app.codecov.io/github/chris-prener/qualmap?branch=main)
[![CRAN_status_badge](https://www.r-pkg.org/badges/version/qualmap)](https://cran.r-project.org/package=qualmap)
[![cran checks](https://badges.cranchecks.info/worst/qualmap.svg)](https://cran.r-project.org/web/checks/check_results_qualmap.html)
